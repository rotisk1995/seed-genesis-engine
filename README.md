...
- Renders that same state as a real-time cellular substrate: material movement ignites colored local cells, encounters diffuse memory, and delivered timber leaves persistent lattice forms. The field has a 1000 × 1000 logical resolution, evaluated as a sparse active frontier so it stays responsive. No resident, house, or settlement icon is drawn as a preset object.
